...
3 - Alterar Procedimento (ainda não implementado)
...
''')
        ...
        if escolha == 1: #Criar
            ...
            print("\n<<<<<<<<<<<<<<<<<<<>>>>>>>>>>>>>>>>>>>\n")
            if len(dados) < 1:
                print("Nenhum procedimento cadastrado ainda")
            else:
                while True:
                    listar_procedimento()
        ...
        if chave_dados == dados[procedimento.title()]:
            while True:
                ...
                match alterar.lower():
                    ...
                    case ("3"|"materiais"):
                        print("Deseja Alterar, Remover ou Adicionar (Alt/Rem/Add)")
                        adicionar = input("-----------:")

                        if adicionar.lower() == "alt" or adicionar.lower() == "alterar":
                        ...
                        elif adicionar.lower() == "rem" or adicionar.lower() == "remover":
                            materiais = chave_dados["Materiais"]
                            print()
                            for valor in materiais:
                                print(valor)
                        ...
                        elif adicionar.lower() == "add" or adicionar.lower() == "adicionar":
                            materiais = chave_dados["Materiais"]
                            print("Digite os materiais utilizados ('fim' para sair)")
                            while True:
                                material = input("-----------:")
